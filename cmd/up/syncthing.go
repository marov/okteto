...
func (up *upContext) sync(ctx context.Context) error {
	...
	if elapsed > maxDuration {
		log.Information("Use the `.stignore` file to skip files from synchronization.")
		log.Information("More information is available here: https://okteto.com/docs/reference/file-synchronization")
	}
